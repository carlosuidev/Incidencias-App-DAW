    ...
    <section id="main-content" class="p-3 lg:ml-56 md:m-0 ml-0">
        <div class="container mx-auto">
            <div class="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div id="historialIncidencias" class="cursor-pointer py-6 px-8 bg-pink-100 w-full overflow-hidden border border-pink-300 rounded-xl hover:border-pink-900 hover:shadow-lg transition duration-300 flex justify-between items-center flex-wrap">
                    <div>
                ...
                <div id="educamadridIncidencias" class="cursor-pointer py-6 px-8 bg-blue-100 w-full overflow-hidden border border-blue-300 rounded-xl hover:border-blue-900 hover:shadow-lg transition duration-300 flex justify-between items-center flex-wrap">
                    <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-1 mt-4" id="proximamente">
