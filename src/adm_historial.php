...
<body class="bg-gray-100 text-gray-800">
    <aside class="hidden sm:flex w-full sm:w-56 shadow-md fixed top-0 bottom-0 lg:left-0 pl-5 overflow-y-auto bg-white flex flex-col justify-between">
        <div>
            ...
            <div class="mt-5">
                ...
                <a href="adm_historial.php" class="duration-300 flex items-center font-bold text-sm rounded-l-lg transition ease-in border-4 border-gray-200 border-r-pink-800 bg-gray-200 hover:bg-gray-200 hover:bg-pink-800 hover:border-pink-800 hover:text-white px-4 py-2 flex mb-2">
    ...
    <div class="container mx-auto">
            <div class="bg-pink-900 rounded p-8 flex mb-5 shadow flex-col items-start justify-center">
                ...
                <p class="pl-10 text-white opacity-75 lg:w-1/2 sm:w-full">Revisa la información de todas las solicitudes que se han realizado en el IES Pío Baroja.</p>
            </div>
    ...
    <script src="js/admin/adm_historial.js"></script>
